...
terraform {
  cloud {
    organization = "youssef-devops-course"  # TODO: change to your own TF Cloud org
    workspaces {
      name = "devops-workshop" # TODO: change your workspace name
    }
  }
...
resource "hcloud_ssh_key" "default" {
  ...
  name       = "workshop-terraform-key-youssef"
